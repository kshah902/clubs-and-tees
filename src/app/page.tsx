    ...
    <>
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden pt-20">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-6 py-24 md:grid-cols-2 md:items-center md:py-32 lg:px-8">
          ...
          {/* Hero visual — arch image placeholder */}
          <div className="relative flex justify-center md:justify-end">
            <div className="relative h-[500px] w-[380px] overflow-hidden rounded-t-[200px] bg-sage/10 md:h-[600px] md:w-[440px]">
              <div className="flex h-full flex-col items-center justify-center text-center">
                ...
                <p className="mt-4 font-heading text-lg italic text-sage/40">
                  Hero Image
                </p>
              </div>
            </div>
      ...
      <section className="overflow-hidden border-y border-stone bg-clay-light py-5">
        <div className="flex animate-marquee gap-16 whitespace-nowrap">
          {[...taglines, ...taglines, ...taglines].map((tag, i) => (
            <span
              key={i}
              className="font-heading text-lg italic text-sage/60"
            >
              {tag}
            </span>
          ))}
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-16 grid max-w-4xl gap-0 md:grid-cols-3">
            {[
              "The drive down the first fairway.",
              "The quiet walk to the green.",
              "The laugh at the 19th hole.",
            ].map((text, i) => (
              <div
                key={i}
                className="border-b border-stone py-8 text-center md:border-b-0 md:border-r md:px-8 md:last:border-r-0"
              >
                <p className="font-heading text-xl italic leading-relaxed text-foreground/70">
                  &ldquo;{text}&rdquo;
                </p>
              </div>
            ))}
          ...
          <div className="mx-auto mt-16 max-w-2xl text-center">
            <p className="text-lg leading-relaxed text-foreground/60">
              Clubs &amp; Tees was created for golfers who appreciate simplicity — on and off the
              course. No flashy graphics. No gimmicks. Just timeless pieces you&apos;ll wear anywhere.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {collectionItems.map((item, i) => (
              <div
                key={i}
                className={`group rounded-3xl bg-white p-8 shadow-soft transition-all duration-500 hover:-translate-y-1 hover:shadow-lg ${
          ...
          <div className="grid items-center gap-16 md:grid-cols-2">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 hidden rounded-3xl bg-clay p-8 shadow-md md:block">
                <p className="font-heading text-lg italic text-forest">
                  &ldquo;Slow Rounds. Good Company.&rdquo;
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="mt-8 text-lg leading-relaxed text-foreground/60">
                Every design is created with simplicity in mind — easy to pair, easy to wear, easy
                to live in.
              </p>
            </div>
          </div>
      ...
      <section className="border-y border-stone py-24 md:py-32">
        <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
          ...
          <h2 className="mt-6 font-heading text-4xl leading-tight text-forest md:text-6xl">
            At Clubs &amp; Tees,{" "}
            <em className="italic text-sage">less is more</em>.
          </h2>
          <div className="mx-auto mt-12 flex max-w-lg flex-wrap justify-center gap-4">
            {["Muted tones", "Minimal graphics", "Balanced composition"].map((item) => (
              <span
                key={item}
                className="rounded-full border border-stone bg-white px-6 py-2.5 text-sm text-foreground/60"
              >
                {item}
              </span>
            ))}
      ...
      {/* ── Shop with Confidence / Amazon Funnel ── */}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-white/60">
              Clubs &amp; Tees is exclusively available through Amazon. That means:
            </p>
          </div>
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-2xl px-6 text-center lg:px-8">
          ...
          <h2 className="mt-6 font-heading text-4xl leading-tight text-forest md:text-5xl">
            ...
            <em className="italic text-sage">Seasonal collections.</em>
          </h2>

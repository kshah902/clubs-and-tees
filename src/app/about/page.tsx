            ...
            {[
              {
                title: "Simplicity",
                description:
                  "No flashy graphics. No gimmicks. Just timeless pieces you'll wear anywhere.",
              },
              {
                title: "Authenticity",
                description:
                  "Designed by golfers, for golfers. Every detail is rooted in the love of the game.",
              },
              {
                title: "Versatility",
                description:
                  "From the first tee to the 19th hole — and everywhere in between.",
              },
            ].map((value, i) => (
              <div
                key={i}
                className={`rounded-3xl bg-white p-8 shadow-soft transition-all duration-500 hover:-translate-y-1 hover:shadow-lg ${
